...
int atop_service_upgrade_status_update_v41(const char* id, const char* key, 
                    int channel, int status, atop_base_response_t* response);

int atop_service_version_update_v41(const char* id, const char* key, 
                    const char *versions, atop_base_response_t* response);
